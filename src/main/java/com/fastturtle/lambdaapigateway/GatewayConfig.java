        ...
        return builder.routes()
                .route("lambda_tts_route", r -> r
                        ...
                        .filters(f -> f.modifyRequestBody(String.class, String.class,
                                ...
                                .modifyResponseBody(String.class, Response.class,
                                        (exchange, responseBody) -> {
                                            try {
                                                return Mono.just(objectMapper.readValue(responseBody, Response.class));
                                            } catch (JsonProcessingException e) {
                                                return Mono.error(new RuntimeException("Error parsing Lambda response", e));
                                            }
                                        }))
                        .uri("no://op"))
                .build();
